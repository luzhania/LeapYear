...
describe("Leap Year", () => {
  ...
  it("The numbers divible by 4 but not by 100 should be considered a leap year, such as 2008 ", () => {
    expect(isLeap(2008)).toEqual(true);
  });
  it("The numbers divible by 4 but not by 100 should be considered a leap year, such as 2012 ", () => {
    expect(isLeap(2012)).toEqual(true);
  });
  it("The numbers divible by 4 but not by 100 should be considered a leap year, such as 2016 ", () => {
